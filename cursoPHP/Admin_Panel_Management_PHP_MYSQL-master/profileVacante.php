...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update'])) {
  $updateVacante = $users->updateVacanteByIdInfo($id, $_POST);

}
if (isset($updateVacante)) {
  echo $updateVacante;
}
 ...
 <div class="card ">
   <div class="card-header">
          <h3>información de la vacante<span class="float-right"> <a href="index.php" class="btn btn-primary">Volver </a> </h3>
        </div>
        <div class="card-body">

    <?php
    $getUinfo = $users->getVacanteInfoById($id);
    if ($getUinfo) {
